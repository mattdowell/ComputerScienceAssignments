 ...
 * 
 */
public class PuzzlePlayerApplet extends JPanel implements MouseListener, ComponentListener {
	...
	public PuzzlePlayerApplet (Puzzle a_puzzle)  {		
		...
		try {
			background = ImageIO.read(getClass().getClassLoader().getResourceAsStream("ics240/Final2/b10.png"));
		} catch (IOException e) {
	...
	}//end constructor PuzzlePlayerApplet	
	...
	private void endGame () {
		...
		case JOptionPane.OK_OPTION :
			...
			add(new PuzzlePlayerApplet(puzzle));
			revalidate();
			repaint();
			break;

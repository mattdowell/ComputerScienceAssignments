...
public class SystemClock extends Thread {
	...
	private static final int SLEEP_TIME_SECONDS = 100 * 1;

	private List<RefridgeratorStateChangeListener> listeners;
	private RefridgeratorSystem configuration;
	 ...
	 * @param configuration
	 */
	public SystemClock(List<RefridgeratorStateChangeListener> inListeners, RefridgeratorSystem configuration) {
		super();
